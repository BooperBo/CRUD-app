...
import ru.naumen.ProjectLibrary.models.Book;
import ru.naumen.ProjectLibrary.models.Person;
import ru.naumen.ProjectLibrary.services.BooksService;
...
public class UserBooksController {
    ...
    @Autowired
    public UserBooksController(BooksService booksService, PeopleService peopleService) {
    ...
    public String index(Model model, @RequestParam(value = "page", required = false) Integer page,
        ...
        return "/user/people/books/index";
    }
